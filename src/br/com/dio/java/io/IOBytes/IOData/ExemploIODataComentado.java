...
/*
Crie um arquivo “peca-de-roupa.dat” e armazene:
...
public class ExemploIODataComentado {
    public static void incluirProduto() throws IOException, EOFException {
        File f = new File("/home/cami/Documents/estoque.bin"); //utilizada para apontar arquivos ou diretórios.
        ...
        dis.close(); //fechando o fluxo de entrada pelo teclado
    ...
    public static void lerArquivoDat(String arquivo) throws IOException {
        ...
        dis.close(); //fechando o fluxo de leitura do arquivo
        ps.close(); //fechando o fluxo de saída para o console
    }

    public static void main(String[] args) throws IOException {
        incluirProduto();
        lerArquivoDat("/home/cami/Documents/estoque.bin");
    }
}
